...
function Library:create(options)
	...
	local status = core:object("TextLabel", {
		...
		Font = Enum.Font.SourceSans,
		Text = "https://ayo.so/cybercorex | Working",
  ...
  creditsTab:credit{Name = "CyberCoreX", Description = "SkyX Hub Developer", Discord = "CyberCoreX#2177", V3rmillion = "chnux01"}
  creditsTab:credit{Name = "x2Skyz", Description = "SkyX Hub Developer", Discord = "x2Skyz#0742", V3rmillion = "0xDEITY"}
